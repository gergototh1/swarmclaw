...
export default function ExtensionPageRoute() {
  ...
  // Where inside its own page the extension is standing, and how it moves.
  // Keeping that in the URL is what lets a reload, a bookmark or a tab come
  // back to it; see `page-location.ts`.
