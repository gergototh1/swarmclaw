...
export default function ProtocolsPage() {
 ...
 <section className="section-band md:">
 ...
 className="rounded-md border border-line-subtle bg-layer-2 px-3 py-2.5 text-[14px] text-text outline-none"
 >
 ...
 className="rounded-sm border border-line-default bg-layer-2 px-2.5 py-1 text-[11px] font-700 text-text-2 transition-all hover:bg-layer-3 cursor-pointer"
 >
 Edit
 </button>
 )}
 ...
 <div className="flex items-center justify-between gap-3">
 <div>
 <div className="text-[12px] font-700 tracking-[0.03em] text-sky-200/72">
 ...
 <section className="section-band min-h-0 ">
 <div className="flex items-center justify-between gap-3">
 <div>
 ...
 type="button"
 onClick={() => setLauncherOpen(true)}
 className="rounded-sm border border-line-default bg-layer-2 px-3 py-1.5 text-[11px] font-700 text-text-2 transition-all hover:bg-layer-3 cursor-pointer"
 >
 Start
 </button>
 </div>
 ...
 className={`rounded-full border px-2.5 py-1 text-[10px] font-700 tracking-[0.03em] transition-all cursor-pointer ${
 ...
 <span className={`shrink-0 rounded-full border px-2 py-0.5 text-[10px] font-700 tracking-[0.03em] ${statusTone(run.status)}`}>
 {run.status}
 </span>
 </div>
 ...
 <section className="section-band min-h-0 md:">
 {detailLoading ? (
 ...
 <span className={`rounded-full border px-3 py-1 text-[11px] font-700 tracking-[0.03em] ${statusTone(detail.run.status)}`}>
 {detail.run.status}
 </span>
 </div>
 <div className="flex flex-wrap gap-2">
 ...
 <div className="text-[11px] font-700 tracking-[0.03em] text-emerald-200/80">Latest Summary</div>
 ...
 <span className={`rounded-full border px-2 py-0.5 text-[10px] font-700 tracking-[0.03em] ${state.joinReady ? statusTone('completed') : statusTone('waiting')}`}>
 ...
 <span className={`rounded-full border px-2 py-0.5 text-[10px] font-700 tracking-[0.03em] ${statusTone(branch.status)}`}>
 {branch.status}
 </span>
 </div>
 ...
 className="rounded-sm border border-line-default bg-layer-2 px-3 py-1.5 text-[11px] font-700 text-text-2 cursor-pointer"
 >
 Open branch
 </button>
 ...
 <span className={`rounded-full border px-2 py-0.5 text-[10px] font-700 tracking-[0.03em] ${statusTone(state.status)}`}>
 {state.status}
 </span>
 </div>
 <div className="mt-3">
 ...
 <span className={`rounded-full border px-1.5 py-0.5 text-[9px] font-700 ${
 ...
 return (
 <div key={step.id} className={`rounded-md border px-4 py-3 ${borderClass}`}>
 <div className="flex items-center justify-between gap-3">
