        ...
        <section className="relative overflow-hidden rounded-lg border border-line-subtle bg-surface">
          ...
          <div className="relative grid gap-6 p-6 md:p-7 xl:grid-cols-[minmax(0,1.4fr)_320px]">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 rounded-full border border-line-default bg-layer-1 px-3 py-1 text-[10px] font-700 uppercase tracking-[0.03em] text-text-3">
                Runtime Safety Desk
              ...
              <div className="flex flex-wrap gap-2">
                <span className={`inline-flex items-center rounded-full px-3 py-1 text-[11px] font-700 uppercase tracking-[0.03em] ${tone.badge}`}>
                  {modeLabel}
                </span>
            ...
            <div className={`rounded-lg border p-5 backdrop-blur-sm ${tone.panel}`}>
              <div className="mb-2 text-[11px] font-700 uppercase tracking-[0.03em] text-text-3">Current State</div>
                  ...
                  >
                    <div className="mb-2 flex items-center justify-between gap-3">
                      <div className="flex items-center gap-2">
                        <span className={`rounded-full px-2.5 py-1 text-[10px] font-700 uppercase tracking-[0.03em] ${governanceTone}`}>
                          {governanceLabel}
                        </span>
          ...
          <section className="rounded-lg border border-line-subtle bg-surface p-5">
            <div className="mb-4 flex items-start gap-3">
              ...
              <button
                ...
                className="rounded-sm border border-line-default bg-layer-1 px-3 py-2 text-[11px] font-700 uppercase tracking-[0.03em] text-text-2 transition-all hover:bg-layer-2 cursor-pointer disabled:cursor-default disabled:opacity-45"
              >
            ...
            <div className="space-y-3">
              <div className="rounded-lg border border-amber-500/16 bg-amber-500/[0.05] p-4">
                <div className="mb-2 flex items-center gap-2">
                  <span className="rounded-full bg-amber-500/12 px-2.5 py-1 text-[10px] font-700 uppercase tracking-[0.03em] text-amber-300">
                    Background only
                  </span>
                </div>
              ...
              <div className="rounded-lg border border-red-500/16 bg-red-500/[0.05] p-4">
                <div className="mb-2 flex items-center gap-2">
                  <span className="rounded-full bg-red-500/12 px-2.5 py-1 text-[10px] font-700 uppercase tracking-[0.03em] text-red-300">
                    Hard stop
                  </span>
                </div>
              ...
              <div className="rounded-lg border border-sky-500/14 bg-sky-500/[0.05] p-4">
                <div className="mb-2 flex items-center gap-2">
                  <span className="rounded-full bg-sky-500/12 px-2.5 py-1 text-[10px] font-700 uppercase tracking-[0.03em] text-sky-300">
                    Policy
                  </span>
                </div>
              ...
              <div className="rounded-lg border border-line-default bg-layer-1 p-4">
                <div className="mb-2 flex items-center gap-2">
                  <span className="rounded-full bg-layer-2 px-2.5 py-1 text-[10px] font-700 uppercase tracking-[0.03em] text-text-3">
                    Recovery
                  </span>
                </div>
                    ...
                    >
                      ...
                      <div className="pl-2">
                        <div className="mb-2 flex flex-wrap items-center gap-2">
                          <span className={`rounded-full px-2.5 py-1 text-[10px] font-700 uppercase tracking-[0.03em] ${severity.badge}`}>
                            {incident.severity}
                          </span>
                        ...
                        {incident.remediation && (
                          <div className="mt-3 rounded-md border border-emerald-500/14 bg-emerald-500/[0.05] px-3 py-2.5">
                            <div className="mb-1 text-[10px] font-700 uppercase tracking-[0.03em] text-emerald-300/85">Remediation</div>
                            ...
                            return (
                              <div className={`mt-3 rounded-md border px-3 py-2.5 ${
                                ...
                                <details className="mt-2 rounded-sm border border-line-subtle bg-black/10">
                                  <summary className="cursor-pointer list-none px-3 py-2 text-[10px] font-700 uppercase tracking-[0.03em] text-text-3 [&::-webkit-details-marker]:hidden">
                        ...
                        {incident.repairPrompt && (
                          <div className="mt-3 rounded-md border border-line-default bg-black/10 px-3 py-2.5">
                            <div className="mb-1 text-[10px] font-700 uppercase tracking-[0.03em] text-text-3">Repair Prompt</div>
