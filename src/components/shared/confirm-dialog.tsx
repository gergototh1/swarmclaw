...
export function ConfirmDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={(nextOpen) => { if (!nextOpen && !cancelDisabled) onCancel() }}>
      <DialogContent
        className="sm:max-w-[400px] rounded-lg border-line-subtle bg-raised p-0 shadow-[0_24px_80px_rgba(0,0,0,0.55)]"
      >
        <div className="p-6">
          ...
          <DialogFooter className="mt-6">
            ...
            <Button
              ...
              className="flex-1 px-4 py-2.5 text-[13px] active:scale-[0.98] disabled:active:scale-100"
            >
              {confirmLabel}
            </Button>
          </DialogFooter>
