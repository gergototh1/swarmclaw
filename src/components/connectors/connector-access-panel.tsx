  ...
  return (
    <div className="rounded-lg border border-line-default bg-layer-1 overflow-hidden">
      ...
      <div className="space-y-4 px-4 py-4">
        {error && (
          <div className="rounded-md border border-red-500/20 bg-red-500/8 px-3 py-2 text-[12px] text-red-200">
            {error}
          </div>
        )}
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
              ...
              <div className="rounded-md border border-line-subtle bg-black/20 px-4 py-4 xl:col-span-2">
                ...
                <div className="mt-3 space-y-2">
                  {snapshot.pendingPairingRequests.length === 0 ? (
                    ...
                    <div key={entry.code} className="flex flex-wrap items-center justify-between gap-3 rounded-md border border-line-subtle bg-layer-1 px-3 py-3">
                      <div className="min-w-0">
