    ...
    <div className="rounded-[18px] border border-line-default bg-layer-1 overflow-hidden">
      ...
      <div className="space-y-4 px-4 py-4">
        ...
        {loading ? (
          ...
          <>
            {hasSelectedSender && (
              <div className="rounded-[14px] border border-line-subtle bg-black/20 px-4 py-4">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
            ...
            <div className="grid grid-cols-2 gap-3 xl:grid-cols-4">
              <div className="rounded-[14px] border border-line-subtle bg-black/20 px-3 py-3">
            ...
            <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
              ...
              <div className="rounded-[14px] border border-line-subtle bg-black/20 px-4 py-4">
                ...
                <div className="mt-3 space-y-2">
                  {snapshot.storedAllowedSenderIds.length === 0 ? (
                    ...
                    <div key={entry} className="flex flex-wrap items-center justify-between gap-2 rounded-[12px] border border-line-subtle bg-layer-1 px-3 py-2">
              ...
              <div className="rounded-[14px] border border-line-subtle bg-black/20 px-4 py-4">
                ...
                <div className="mt-3 space-y-2">
                  {snapshot.senderAddressingOverrides.length === 0 ? (
                    ...
                    <div key={entry.senderId} className="flex flex-wrap items-center justify-between gap-2 rounded-[12px] border border-line-subtle bg-layer-1 px-3 py-2">
              ...
              <div className="rounded-[14px] border border-line-subtle bg-black/20 px-4 py-4 xl:col-span-2">
                ...
                <div className="mt-3 space-y-2">
                  {snapshot.pendingPairingRequests.length === 0 ? (
                    ...
                    <div key={entry.code} className="flex flex-wrap items-center justify-between gap-3 rounded-[12px] border border-line-subtle bg-layer-1 px-3 py-3">
                      <div className="min-w-0">
