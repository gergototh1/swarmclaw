...
export function ConnectorInbox() {
 ...
 return (
 <div className="page-frame flex h-full flex-col gap-4">
 ...
 <section className="section-band overflow-hidden min-h-[260px] xl:min-h-0 flex flex-col">
 ...
 />
 <div>
 <div className="text-[10px] tracking-[0.03em] text-text-3 mb-2">Connector type</div>
 <select
 ...
 <div className="text-[10px] tracking-[0.03em] text-text-3">
 ...
 <span className="inline-flex items-center gap-1 rounded-full bg-layer-2 px-2 py-1 text-[10px] tracking-[0.03em] text-text-3">
 ...
 <span className="rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2.5 py-1 text-[10px] tracking-[0.03em] text-emerald-200">
 {conversationAccessSummary.counts.approved} approved
 </span>
 <span className="rounded-full border border-amber-500/20 bg-amber-500/10 px-2.5 py-1 text-[10px] tracking-[0.03em] text-amber-200">
 {conversationAccessSummary.counts.pending} pending
 </span>
 <span className="rounded-full border border-red-500/20 bg-red-500/10 px-2.5 py-1 text-[10px] tracking-[0.03em] text-red-200">
 {conversationAccessSummary.counts.blocked} blocked
 </span>
 {conversationAccessSummary.counts.restricted > 0 && (
 <span className="rounded-full border border-orange-500/20 bg-orange-500/10 px-2.5 py-1 text-[10px] tracking-[0.03em] text-orange-200">
 ...
 {accessState && (
 <span className={`inline-flex items-center rounded-full border px-2.5 py-1 text-[10px] tracking-[0.03em] ${accessClasses?.badge || ''}`}>
 {accessState.label}
 </span>
 )}
 {agent ? (
 <span className="inline-flex items-center gap-1 rounded-full border border-line-default bg-layer-1 px-2 py-1 text-[10px] tracking-[0.03em] text-text-2">
 <AgentAvatar
 ...
 <span className="inline-flex items-center rounded-full border border-line-subtle bg-layer-1 px-2 py-1 text-[10px] tracking-[0.03em] text-text-3">
 Unassigned
 </span>
 )}
 </div>
 ...
 <section className="section-band overflow-hidden min-h-[380px] xl:min-h-0 flex flex-col">
 {selectedSession ? (
 <>
 ...
 <span className="inline-flex items-center gap-1 rounded-full bg-layer-2 px-2.5 py-1 text-[10px] tracking-[0.03em] text-text-3">
 ...
 <span className="rounded-full bg-emerald-500/10 px-2.5 py-1 text-[10px] tracking-[0.03em] text-emerald-300">
 ...
 {accessSnapshot && (
 <span className="rounded-full bg-layer-2 px-2 py-0.5 text-[10px] tracking-[0.03em] text-text-3">
