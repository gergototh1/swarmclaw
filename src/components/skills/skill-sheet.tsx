...
export function SkillSheet() {
  ...
  return (
    <BottomSheet open={open} onClose={onClose} wide>
      ...
      {!editing && (
        <div className="mb-8">
          <label
            ...
            className="flex items-center justify-center gap-2.5 w-full py-4 rounded-[14px] border border-dashed border-line-default bg-transparent text-text-3 text-[14px] font-600 cursor-pointer hover:border-accent-bright/30 hover:text-accent-bright hover:bg-accent-soft transition-all duration-200"
          >
      ...
      {!editing && (
        <div className="mb-8 p-4 rounded-[14px] border border-line-default bg-surface">
      ...
      {metadataPreview && (
        <div className="mb-8 rounded-[14px] border border-line-default bg-layer-1 p-4">
