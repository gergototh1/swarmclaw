  ...
  return (
    <BottomSheet open={open} onClose={onClose} wide>
      ...
      {!editing && (
        <div className="mb-8">
          <label
            ...
            className="flex items-center justify-center gap-2.5 w-full py-4 rounded-md border border-dashed border-line-default bg-transparent text-text-3 text-[14px] font-600 cursor-pointer hover:border-accent-bright/30 hover:text-accent-bright hover:bg-accent-soft transition-all duration-200"
          >
        ...
        <div className="mb-8 p-4 rounded-md border border-line-default bg-surface">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-3 rounded-md border-none bg-accent-bright text-white text-[13px] font-600 cursor-pointer disabled:opacity-30 transition-all hover:brightness-110"
              style={{ fontFamily: 'inherit' }}
            >
      ...
      <div className="flex gap-3 pt-2 border-t border-line-subtle">
        ...
        <button onClick={handleSave} disabled={!name.trim() || !content.trim()} className="flex-1 py-3.5 rounded-md border-none bg-accent-bright text-white text-[15px] font-600 cursor-pointer active:scale-[0.97] disabled:opacity-30 transition-all shadow-[0_4px_20px_rgba(99,102,241,0.25)] hover:brightness-110" style={{ fontFamily: 'inherit' }}>
          {editing ? 'Save' : 'Create'}
        </button>
      </div>
      <ConfirmDialog
