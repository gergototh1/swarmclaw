...
export function OrgChartToolbar({ onAutoLayout, onZoomIn, onZoomOut, onFitToScreen, scale }: Props) {
  return (
    <div className="absolute top-4 right-4 z-20 flex items-center gap-1 bg-raised/80 backdrop-blur-sm border border-line-subtle rounded-sm px-1.5 py-1 shadow-lg" onPointerDown={(e) => e.stopPropagation()}>
