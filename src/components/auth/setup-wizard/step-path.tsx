  ...
  return (
    <StepShell wide>
      ...
      <div className="mt-6 flex items-center justify-center gap-3">
        <button
          onClick={onBack}
          className="px-6 py-3.5 rounded-md border border-line-default bg-transparent text-text-2 text-[14px] font-display font-600 cursor-pointer hover:bg-layer-1 transition-all duration-200"
        >
          Back
        </button>
        <button
