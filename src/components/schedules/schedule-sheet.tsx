        ...
        <>
          {previewOk.nextRuns.length > 0 ? (
            <div className="space-y-1.5">
              <div className="text-[11px] text-text-3 uppercase tracking-[0.03em] font-600">Next runs</div>
      ...
      {step === reviewStep && (
        <div className="mb-8">
          <div className="p-5 rounded-lg bg-surface border border-line-subtle space-y-4">
            <div>
              <span className="text-[11px] text-text-3 uppercase tracking-[0.03em] font-600">Name</span>
              <div className="text-[14px] text-text font-600 mt-0.5">{name}</div>
            </div>
            <div>
              <span className="text-[11px] text-text-3 uppercase tracking-[0.03em] font-600">Agent</span>
              <div className="text-[14px] text-text font-600 mt-0.5">{selectedAgent?.name || agentId}</div>
            </div>
            {editing && (
              <div>
                <span className="text-[11px] text-text-3 uppercase tracking-[0.03em] font-600">Created By</span>
                {creatorAgent ? (
            ...
            <div>
              <span className="text-[11px] text-text-3 uppercase tracking-[0.03em] font-600">Mode</span>
            ...
            <div>
              <span className="text-[11px] text-text-3 uppercase tracking-[0.03em] font-600">{taskMode === 'wake_only' ? 'Wake Message' : taskMode === 'protocol' ? 'Session Goal' : 'Task'}</span>
            ...
            {taskMode === 'protocol' && message.trim() && (
              <div>
                <span className="text-[11px] text-text-3 uppercase tracking-[0.03em] font-600">Kickoff Context</span>
                <div className="text-[13px] text-text-2 mt-0.5 whitespace-pre-wrap">{message}</div>
              </div>
            )}
            {taskMode === 'protocol' && (
              <div>
                <span className="text-[11px] text-text-3 uppercase tracking-[0.03em] font-600">Template</span>
                <div className="text-[13px] text-text-2 mt-0.5">Single-agent structured run</div>
              </div>
            )}
            <div className="h-px bg-layer-2" />
            <div>
              <span className="text-[11px] text-text-3 uppercase tracking-[0.03em] font-600">Schedule</span>
            ...
            {editing && (
              <div>
                <span className="text-[11px] text-text-3 uppercase tracking-[0.03em] font-600">Status</span>
