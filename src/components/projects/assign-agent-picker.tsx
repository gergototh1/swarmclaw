...
export function AssignAgentPicker({ projectId, onClose }: { projectId: string; onClose: () => void }) {
  ...
  return (
    <>
      ...
      <div className="absolute left-0 top-full mt-2 z-50 w-[260px] rounded-md bg-surface/95 backdrop-blur-xl border border-line-default shadow-[0_12px_40px_rgba(0,0,0,0.5)] overflow-hidden">
        <div className="p-2.5 border-b border-line-subtle">
          <input
            ...
            autoFocus
            className="w-full px-2.5 py-1.5 text-[12px] bg-layer-2 rounded-sm border border-line-default text-text placeholder:text-text-3/50 outline-none"
