...
export function DaemonIndicator() {
  ...
  return (
    <button
      onClick={toggle}
      className="flex items-center gap-2 px-3 py-2 rounded-[10px] bg-surface border border-line-subtle hover:bg-surface-2 transition-colors cursor-pointer w-full"
