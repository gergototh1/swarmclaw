...
export function CodeBlock({ children, className }: Props) {
  ...
  return (
    <div className="relative group/code command-surface">
      <div className="flex items-center justify-between px-4 py-2 bg-layer-3 border-b border-line-subtle">
          ...
          {canPreview && (
            <>
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-[10px] font-600 bg-transparent border-none cursor-pointer
                  transition-all duration-200 px-2 py-0.5 rounded-xs text-text-3 hover:text-text-2 hover:bg-layer-2"
                style={{ fontFamily: 'inherit' }}
