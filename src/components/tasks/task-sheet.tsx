    ...
    return (
      <BottomSheet open={open} onClose={onClose}>
        ...
        {editing.error && (() => {
          ...
          return (
            <div className="mb-8">
              <label className={`block font-display text-[12px] font-600 tracking-[0.03em] mb-3 ${labelTone}`}>{label}</label>
        ...
        <div className="flex gap-3 pt-2 border-t border-line-subtle">
          ...
          <button
            ...
            className="flex-1 py-3.5 rounded-md border-none bg-accent-bright text-accent-fg text-[15px] font-600 cursor-pointer active:scale-[0.97] transition-all hover:brightness-110"
            style={{ fontFamily: 'inherit' }}
          >
            Edit
          </button>
  ...
  return (
    <BottomSheet open={open} onClose={onClose}>
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap gap-2">
          {([['', 'None', 'bg-surface border-line-subtle text-text-2'],
      ...
      <div className="mb-8">
        ...
        {editing && Array.isArray(editing.blocks) && editing.blocks.length > 0 && (
          <div className="mt-3">
            <span className="text-[11px] font-600 text-text-3 tracking-[0.03em]">Blocks:</span>
