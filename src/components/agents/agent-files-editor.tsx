        ...
        {FILES.map((f) => {
          ...
          return (
            <button
              ...
              className={`px-2.5 py-1.5 rounded-sm text-[11px] font-600 cursor-pointer transition-all whitespace-nowrap
                ${activeTab === f
      ...
      {GUIDED_FILES.has(activeTab) && (
        <div className="px-3 py-1 shrink-0">
          <button
            ...
            className={`text-[10px] font-600 px-2 py-0.5 rounded-xs cursor-pointer transition-all border-none
