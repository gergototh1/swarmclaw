  ...
  return (
    <div className="mb-10">
      ...
      <div className="p-6 rounded-lg bg-surface border border-line-subtle space-y-5">
        <div>
          <label className="block font-display text-[11px] font-600 text-text-3 tracking-[0.03em] mb-3">Recommendation Mode</label>
        ...
        <div>
          <label className="block font-display text-[11px] font-600 text-text-3 tracking-[0.03em] mb-3">Default Top K</label>
          <input
            type="number"
            min={1}
            max={20}
