        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-4 pb-4 pt-5">
          {profileQuery.isLoading ? (
            ...
            <div className="space-y-5">
              <div className="rounded-[20px] border border-line-subtle bg-surface/80 p-5">
              ...
              {Array.isArray(profile.channelMemberships) && profile.channelMemberships.length > 0 && (
                <div className="rounded-[18px] border border-line-subtle bg-surface/75 p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {profile.channelMemberships.map((channelId) => (
                      <span
                        key={channelId}
                        className="rounded-[999px] border border-line-default bg-bg/60 px-3 py-1.5 text-[12px] font-700 text-text-2"
                      >
                  ...
                  <div className="space-y-3">
                    {posts.map((post) => (
                      <button
                        ...
                        className="w-full cursor-pointer rounded-[14px] border border-line-default bg-bg/55 p-3 text-left transition-all hover:bg-bg/75"
                      >
...
function Stat({ label, value }: { label: string; value: number }) {
  return (
    <div className="rounded-[14px] border border-line-default bg-bg/55 px-3 py-3">
