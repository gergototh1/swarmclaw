const COMMAND_GROUPS = {
  ...
  extensions: {
    ...
    commands: {
      ...
      update: { description: 'Enable or disable an extension (body: {"filename":"x.js","enabled":true}); enabling also creates or updates the agents and routines it declares', method: 'POST', path: '/extensions' },
      marketplace: { description: 'Get extension marketplace registry', method: 'GET', path: '/extensions/marketplace' },
      install: { description: 'Install extension by URL and create the agents and routines it declares', method: 'POST', path: '/extensions/install' },
      ...
      reconcile: { description: 'Create or update the agents and routines extensions declare (all of them, or one with --extension-id video.mjs); the host already does this on install, enable and upgrade, so this is for asking again', method: 'POST', path: '/extensions/managed-resources' },
